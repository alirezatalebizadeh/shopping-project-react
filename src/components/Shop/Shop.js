...
export default function Shop() {
    ...
    const removeProductFromBasket = (ProductId) => {
        let basketFiltered = shoppingCart.filter(product => {
            return product.id !== ProductId
        })

        setShoppingCart(basketFiltered)
    }
    ...
    return (
        <>
            <header className="main-header">
                ...
                <h1 className="band-name band-name-large"> pardis shopping</h1>
            </header>
            ...
            <section className="container content-section">
                <div className="shop-items">
                    ...
                    {products.map(product => (
                        <Product onAddToCard={addToShop} {...product} key={product.id} />
                    ))}
            ...
            <section className="container content-section">
                ...
                <div className="cart-items">
                    ...
                    {shoppingCart.map(product => (
                        <CartProduct onRecieveId={removeProductFromBasket} {...product} key={product.id} />
                    ))}
                </div>
                <button className="btn btn-primary btn-purchase" onClick={removeCart} type="button">
                    Empty Cart
                </button>
            </section>
            <footer className="main-footer">
